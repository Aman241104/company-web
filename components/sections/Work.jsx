...
export const projects = [
  ...
  },
  {
    ...
    accent: '#D97706',
    mockupType: 'browser',
    mockupUrl: 'www.prihaanspices.in',
  ...
  },
  {
    ...
    accent: '#60A5FA',
    mockupType: 'browser',
    mockupUrl: 'www.silverspoonbyacj.com',
  ...
  },
  {
    ...
    accent: '#EC4899',
    mockupType: 'browser',
    mockupUrl: 'www.zingblissevents.com',
  ...
  },
  {
    ...
    accent: '#3B82F6',
    mockupType: 'browser',
    mockupUrl: 'www.aresbusinessleague.com',
  ...
  },
  {
    ...
    accent: '#8B5CF6',
    mockupType: 'browser',
    mockupUrl: 'www.clubmjevents.com',
  ...
  },
  {
    ...
    accent: '#0284C7',
    mockupType: 'browser',
    mockupUrl: 'www.naamtransfer.com',
  ...
  },
  {
    ...
    accent: '#10B981',
    mockupType: 'browser',
    mockupUrl: 'www.thenexsphereglobal.com',
  ...
  },
  {
    ...
    accent: '#EAB308',
    mockupType: 'browser',
    mockupUrl: 'www.risingrechargeable.com',
  ...
  },
  {
    ...
    accent: '#EC4899',
    mockupType: 'browser',
    mockupUrl: 'www.aanganboutique.in',
  ...
  },
  {
    ...
    categoryFilter: 'Web',
    tags: ['Next.js', 'Modular Interiors', 'Ahmedabad', 'Turnkey Execution'],
    result: 'Turnkey Interior Delivery',
    year: '2024',
    type: 'Client Project',
    accent: '#B45309',
    mockupType: 'browser',
    mockupUrl: 'www.sidecor.in',
    MockupContent: SS('/assets/stylux_mockup.jpg', 'SI Decor & Interiors'),
    link: 'https://www.sidecor.in',
    desc: 'Modern architectural interiors, turnkey residential styling, bespoke modular kitchens, and commercial space design.',
  },
  {
    id: '17',
    name: 'Jade Travels',
    category: 'Corporate & Luxury Travel',
    categoryFilter: 'Web',
    tags: ['Next.js', 'Corporate Itinerary', 'Holiday Packages', 'Flight Booking'],
    result: 'Corporate Travel Hub',
    year: '2024',
    type: 'Client Project',
    accent: '#0D9488',
    mockupType: 'browser',
    mockupUrl: 'www.jadetravels.co.in',
    MockupContent: SS('/destination.png', 'Jade Travels International'),
    link: 'https://www.jadetravels.co.in',
    desc: 'Corporate travel management, international holiday packages, flight bookings, and customized luxury travel itineraries.',
  },
]
